...
# -----------------------------------------------------------------------------
DEVICES = [
    ("Temperature", "TemperatureMQTTset.csv",     "sensor_temp1", "temp123"),
    ("Temperature", "TemperatureMQTTset.csv",     "sensor_temp2", "temp123"),
    ("Temperature", "TemperatureMQTTset.csv",     "sensor_temp3", "temp123"),
    ("Temperature", "TemperatureMQTTset.csv",     "sensor_temp4", "temp123"),
    ("Temperature", "TemperatureMQTTset.csv",     "sensor_temp5", "temp123"),
    ("Temperature", "TemperatureMQTTset.csv",     "sensor_temp6", "temp123"),
    ("Temperature", "TemperatureMQTTset.csv",     "sensor_temp7", "temp123"),
    ("Temperature", "TemperatureMQTTset.csv",     "sensor_temp8", "temp123"),
    ("Humidity",    "HumidityMQTTset.csv",        "sensor_hum1", "hum123"),
    ("Humidity",    "HumidityMQTTset.csv",        "sensor_hum2", "hum123"),
    ("Humidity",    "HumidityMQTTset.csv",        "sensor_hum3", "hum123"),
    ("Humidity",    "HumidityMQTTset.csv",        "sensor_hum4", "hum123"),
    ("Humidity",    "HumidityMQTTset.csv",        "sensor_hum5", "hum123"),
    ("Humidity",    "HumidityMQTTset.csv",        "sensor_hum6", "hum123"),
    ("Humidity",    "HumidityMQTTset.csv",        "sensor_hum7", "hum123"),
    ("Humidity",    "HumidityMQTTset.csv",        "sensor_hum8", "hum123"),
    ("Light", "LightIntensityMQTTset.csv", "sensor_light1", "light123"),
    ("Light", "LightIntensityMQTTset.csv", "sensor_light2", "light123"),
    ("Light", "LightIntensityMQTTset.csv", "sensor_light3", "light123"),
    ("Light", "LightIntensityMQTTset.csv", "sensor_light4", "light123"),
    ("Light", "LightIntensityMQTTset.csv", "sensor_light5", "light123"),
    ("DoorLock",    "DoorlockMQTTset.csv",        "sensor_door1", "door123"),
    ("DoorLock",    "DoorlockMQTTset.csv",        "sensor_door2", "door123"),
    ("DoorLock",    "DoorlockMQTTset.csv",        "sensor_door3", "door123"),
    ("DoorLock",    "DoorlockMQTTset.csv",        "sensor_door4", "door123"),
    ("DoorLock",    "DoorlockMQTTset.csv",        "sensor_door5", "door123"),
]
