...
DEVICES = [
    ...
    ("Temperature", "TemperatureMQTTset.csv", "office-sensortemp9-replayer", "temp123"),
    ("Temperature", "TemperatureMQTTset.csv", "office-sensortemp10-replayer", "temp123"),
    ("Temperature", "TemperatureMQTTset.csv", "office-sensortemp11-replayer", "temp123"),
    ("Temperature", "TemperatureMQTTset.csv", "office-sensortemp12-replayer", "temp123"),
    ("Temperature", "TemperatureMQTTset.csv", "office-sensortemp13-replayer", "temp123"),
    ...
    ("Humidity", "HumidityMQTTset.csv", "office-sensorhum9-replayer", "hum123"),
    ("Humidity", "HumidityMQTTset.csv", "office-sensorhum10-replayer", "hum123"),
    ("Humidity", "HumidityMQTTset.csv", "office-sensorhum11-replayer", "hum123"),
    ("Humidity", "HumidityMQTTset.csv", "office-sensorhum12-replayer", "hum123"),
    ("Humidity", "HumidityMQTTset.csv", "office-sensorhum13-replayer", "hum123"),
    ...
    ("Light", "LightIntensityMQTTset.csv", "office-sensorlight6-replayer", "light123"),
    ("Light", "LightIntensityMQTTset.csv", "office-sensorlight7-replayer", "light123"),
    ("Light", "LightIntensityMQTTset.csv", "office-sensorlight8-replayer", "light123"),
    ("Light", "LightIntensityMQTTset.csv", "office-sensorlight9-replayer", "light123"),
    ("Light", "LightIntensityMQTTset.csv", "office-sensorlight10-replayer", "light123"),
