...
DEVICES = [
    ...
    ("FlameSensor", "Edge-IIoTset_flame_sensor.csv", "production-sensorflame6-replayer", "flame123"),
    ("FlameSensor", "Edge-IIoTset_flame_sensor.csv", "production-sensorflame7-replayer", "flame123"),
    ("FlameSensor", "Edge-IIoTset_flame_sensor.csv", "production-sensorflame8-replayer", "flame123"),
    ("FlameSensor", "Edge-IIoTset_flame_sensor.csv", "production-sensorflame9-replayer", "flame123"),
