# payload_anomaly.py  (TLS-enabled, sends ONLY oversized payloads)
# Example run: python payload_anomaly.py
...
class PayloadAnomalyAttackTLS:
    ...
    def create_client(self, client_id):
        ...
        try:
            ...
            # 🔐 Hardcoded username and password (edit here if needed)
            username = "giamdoc"
            password = "123"
...
def main():
    # Modify broker IP, port and CA path here if needed
